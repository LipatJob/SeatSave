    ...
    return (
        <div class='bg-slate-200 min-h-screen min-w-screen flex items-center justify-center'>
            <div class='bg-slate-300 w-3/4 min-h-screen m-20 rounded-md'>
                ...
                <h2 class='text-2xl pl-48 pt-5'>Center for Learning and Information Resources - Einstein Bldg.</h2>
                ...
                <div class='flex justify-center'>
                    <div class='py-6'>
                        <button class='bg-pearl-bush rounded-md w-30 mx-5'>
                            <h3 class='text-2xl px-12 py-4'>3:00<br/>4:00</h3>
                        </button>

                        <button class='bg-pearl-bush rounded-md w-30 mx-5'>
                            <h3 class='text-2xl px-12 py-4'>4:00<br/>5:00</h3>
                        </button>
                    </div>
                </div>
