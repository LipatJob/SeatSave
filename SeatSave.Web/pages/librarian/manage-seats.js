...
export default function ManageSeats() {
    return (
      ...
      <div className='bg-slate-200 min-h-screen min-w-screen flex items-center justify-center'>  
          ...
          <div className="col-span-1 flex flex-col items-center">
            ...
            <div className="w-full">
              <table className="w-full border-pearl-bush border-2">
                ...
                <tbody>
                  <tr><td><div className='px-4 py-4'></div></td></tr>
                  <tr>
                    <td className='px-4 flow-root'><button className="float-left w-full border-2 border-iron bg-transparent px-4 text-left text-black hover:bg-pearl-bush hover:text-black focus:border-4 focus:border-blue-300 "> ABCD <span className="float-right text-dawn">132</span></button></td>
                  </tr>
                  <tr>
                    <td className='px-4 flow-root'><button className="float-left w-full border-2 border-iron bg-transparent px-4 text-left text-black hover:bg-pearl-bush hover:text-black focus:border-4 focus:border-blue-300 "> ABCD <span className="float-right text-dawn">132</span></button></td>
                  </tr>
                  ...
                  <tr><td><div className='px-4 py-40'></div></td></tr>
                  <tr>
                    <td>
                      <div className="w-full text-right pr-4 pb-4">
                        <button
            ...
            <table className="w-full border-pearl-bush border-2">
              ...
              <tbody>
                <tr>
                  <td>
                    <div className="pl-4 w-full">
                      <div className="h-6 mt-3 text-black leading-8 ">Seat ID</div>
                      <div className="my-2 bg-iron p-1 flex border border-iron w-3/12"> 
                        <input placeholder="Text" className="p-1 px-2 bg-iron appearance-none outline-none w-full text-black"></input>  </div>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <div className="px-4 w-full">
                    <div className="h-6  text-black leading-8 ">Name</div>
                    <div className="my-2 bg-white p-1 flex border border-iron"> 
                      <input placeholder="Enter Seat Name" className="p-1 px-2 appearance-none outline-none w-full text-black"></input>  </div>
                  </div>
                  </td>
                </tr>
                <tr>
                  <td>
                  <div className="px-4 w-full">
                  <div className="h-6  text-black leading-8 ">Seat Type</div>
                    ...
                    <select defaultValue={"0"}  className=" border  w-full border-iron flex  p-1 px-2  text-black h-10  bg-white hover:border-gray-400 focus:outline-none appearance-none">
                ...
                <tr>
                  <td>
                  <div className="px-4 w-full">
                  <div className="h-6 text-black leading-8 ">Description</div>
                  <div className="my-2 mb-4 bg-white p-1 flex border border-iron"> 
                ...
                <tr>
                  <td>
                  <div className="grid grid-cols-5 px-4 w-full py-4" >
                  ...
                  <input type="checkbox" className="form-checkbox h-4 w-4 mr-2 text-dusk-blue" defaultChecked></input>
                    Activate Seat
                  </div>
                  <div className="col-span-1 text-center">
                  <button className="p-2 pl-5 pr-5 bg-dawn text-white focus:border-4 text-center ">CANCEL</button>
                  </div>
                  <button className="p-2 pl-5 pr-5 bg-bluish text-white focus:border-4 w-full ">SAVE</button>
                  </div>
                  </td>
                </tr>
              </tbody>
